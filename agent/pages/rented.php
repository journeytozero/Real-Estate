...
$stmt = $conn->prepare("
    ...
    WHERE p.agent_id=? AND p.status='Rented'
...
<div class="content">
    <h2 class="mb-4">Rented Properties</h2>
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    <?php if ($rented_properties): ?>
                        ...
                        <?php endforeach; ?>
                    <?php else: ?>
                        <tr><td colspan="6" class="text-center">No rented properties found.</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>
